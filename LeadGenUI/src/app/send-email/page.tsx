...
import SendHistory from "@/components/Email/SendHistory";
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 space-y-5">
        <div>
          <h1 className="text-base font-medium text-foreground">Send Emails</h1>
          <p className="text-xs text-muted-foreground mt-0.5">
            Send your email templates to the contacts found during crawling.
          </p>
        </div>
        ...
        {loading ? (
          ...
          <>
            <EmailSender onSendStarted={handleSendStarted} />
            <SendHistory refreshTrigger={historyTrigger} />
          </>
        )}
      </main>
    </div>
